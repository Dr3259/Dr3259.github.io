                            ...
                            <CardHeader>
                             ...
                             <CardContent className="space-y-4">
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-3">
                                    <div className="flex items-center gap-2 text-sm col-span-1 lg:col-span-1">
                                    ...
                                    <InfoRow icon={User} label={t.director} value={movie.director} className="lg:col-span-2" />
                                    ...
                                    <InfoRow icon={Subtitles} label={t.subtitles} value={movie.subtitles} className="lg:col-span-2" />
                                </div>

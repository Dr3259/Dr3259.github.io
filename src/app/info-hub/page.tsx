...
import { ArrowLeft, Rss, Loader2, Sparkles, Link as LinkIcon, Send } from 'lucide-react';
import { researchTopic, type ResearchTopicOutput } from '@/ai/flows/info-hub-flow';

const translations = {
  'zh-CN': {
    pageTitle: '聚合信息',
    pageSubtitle: '输入一个话题，AI 将为您搜索并生成一份摘要报告。',
    backButton: '返回休闲驿站',
    inputPlaceholder: '例如：最新的 AI 技术进展',
    generateButton: '生成报告',
    generating: '正在生成中...',
  ...
  'en': {
    pageTitle: 'Info Hub',
    pageSubtitle: 'Enter a topic, and the AI will search and generate a summary report for you.',
    backButton: 'Back to Rest Stop',
    inputPlaceholder: 'e.g., Latest advancements in AI technology',

...
const spiceData = {
  'zh-CN': {
    chinese: [
        { id: 'starAnise', name: '八角', features: '甘香微甜，香气醇厚', preprocessing: '整颗用，卤前温水泡10分钟', compatibleFood: '猪肉、牛肉、禽类', pairingSuggestion: '桂皮、香叶、小茴香', efficacy: '性温，归肝、肾、脾经；温中散寒、理气止痛、和胃止呕；可辅助缓解胃寒呕吐、脘腹冷痛', contraindications: '阴虚火旺者（口干舌燥、手足心热）忌用；风热感冒、发烧者慎用' },
        { id: 'sichuanPepper', name: '花椒', features: '辛香带麻，层次丰富', preprocessing: '干用或炝油', compatibleFood: '川菜、牛肉、羊肉、豆制品', pairingSuggestion: '辣椒、孜然、生姜', efficacy: '性温，归脾、胃、肾经；温中止痛、杀虫止痒、除湿；可辅助缓解寒湿泄泻、胃寒腹痛', contraindications: '阴虚火旺者（牙龈肿痛、便秘）忌用；孕妇慎用（过量可能刺激子宫）；热性皮肤病（湿疹、痤疮）患者慎用' },
    ...
    european: [
      ...
      { id: 'parsley', name: '欧芹', features: '清新芹菜香，脆嫩爽口', preprocessing: '不可久煮', compatibleFood: '沙拉、酱汁、海鲜、汤', pairingSuggestion: '柠檬、大蒜、黄油', efficacy: null, contraindications: null },
      { id: 'oregano', name: '牛至', features: '辛辣微苦，带茴香感', preprocessing: '干品香味更浓', compatibleFood: '披萨、意面、烤肉、番茄酱', pairingSuggestion: '番茄、大蒜、辣椒', efficacy: null, contraindications: null },
      { id: 'dill', name: '莳萝', features: '甜香带茴香，清爽解腻', preprocessing: '鲜用易蔫', compatibleFood: '三文鱼、黄瓜、酸奶酱、土豆', pairingSuggestion: '柠檬、酸奶、黄瓜', efficacy: null, contraindications: null },
    ],
    southeastAsian: [
  ...
  'en': {
    chinese: [
        { id: 'starAnise', name: 'Star Anise', features: 'Sweet & fragrant, full-bodied', preprocessing: 'Use whole, soak in warm water', compatibleFood: 'Pork, Beef, Poultry', pairingSuggestion: 'Cassia, Bay Leaf, Fennel', efficacy: 'Warm; benefits liver, kidney, spleen; warms middle-jiao, dispels cold, regulates qi, stops pain.', contraindications: 'Avoid if yin-deficient with fire; caution during febrile colds.' },

...
const cuisineData: Record<string, Record<string, Cuisine>> = {
    'zh-CN': {
        lu: {
            ...
            origin: <><p>鲁菜是中国八大菜系中历史最悠久、技法最丰富的菜系，起源于春秋战国时期的齐国和鲁国（今山东地区），受儒家“食不厌精，脍不厌细”的饮食思想影响深远。</p><p>主要分为三大流派：</p><ul className="list-disc pl-5 mt-2 space-y-1"><li>**济南菜**：以清汤、奶汤菜见长，口味醇厚，注重火候。</li><li>**胶东菜**（福山菜）：以海鲜为主，讲究鲜活，口味清淡鲜爽，擅长蒸、炸、扒。</li><li>**孔府菜**：源于曲阜孔府，是“官府菜”的代表，讲究礼仪和排场，用料奢华，工艺复杂。</li></ul></>,
        ...
        chuan: {
            ...
            origin: <><p>川菜起源于古代巴国和蜀国（今四川、重庆地区），受巴蜀文化影响，结合了当地潮湿气候对“驱寒祛湿”的饮食需求，在明清时期形成规模，现分为**川味菜肴**和**川味小吃**两大体系，核心流派为：</p><ul className="list-disc pl-5 mt-2 space-y-1"><li>**上河帮**（成都、乐山菜）：口味温和，注重调味的层次感，擅长做鱼和小吃（如乐山钵钵鸡、成都夫妻肺片）。</li><li>**下河帮**（重庆、万州菜）：口味浓烈，以麻辣鲜香为主，擅长江湖菜（如重庆火锅、万州烤鱼）。</li><li>**小河帮**（自贡、内江菜）：以“鲜辣”“味厚”为特色，擅长做兔肉和河鲜（如冷吃兔、鲜锅兔）。</li></ul></>,
        ...
        yue: {
            ...
            origin: <><p>粤菜起源于岭南地区（今广东、广西东部、海南），受中原文化、海外贸易（如东南亚、欧美）影响，形成了“兼容并蓄、注重鲜活”的特点，是中国八大菜系中**海外影响力最大**的菜系。</p><ul className="list-disc pl-5 mt-2 space-y-1"><li>**广府菜**（广州、佛山菜）：以清淡、鲜爽为主，擅长清蒸、白灼，注重食材本味（如清蒸石斑鱼、白灼虾）。</li><li>**潮汕菜**（潮州、汕头菜）：以海鲜和卤味见长，刀工精细，口味鲜香，擅长腌制和砂锅菜（如潮汕牛肉火锅、卤鹅）。</li><li>**客家菜**（梅州、惠州菜）：源于中原移民，口味偏咸香，擅长炖、煲、酿，注重食材的“质朴本味”（如客家酿豆腐、梅菜扣肉）。</li></ul></>,
        ...
        su: {
            ...
            origin: <><p>苏菜起源于春秋战国时期的吴国（今江苏地区），受江南水乡文化和文人雅士的审美影响，以“精细、雅致”著称，与浙菜并称“江南菜系”的核心。</p><ul className="list-disc pl-5 mt-2 space-y-1"><li>**淮扬菜**（淮安、扬州菜）：苏菜的核心，口味清鲜平和，擅长河鲜和禽畜，注重刀工和造型（如扬州炒饭、清炖狮子头）。</li><li>**金陵菜**（南京菜）：口味醇和，擅长炖、焖、烤，因南京曾为都城，菜品兼具“家常”与“宫廷”特色（如盐水鸭、鸭血粉丝汤）。</li><li>**苏锡菜**（苏州、无锡菜）：口味偏甜，擅长做水产和甜食（如松鼠鳜鱼、无锡酱排骨）。</li><li>**徐海菜**（徐州、连云港菜）：受鲁菜影响，口味偏咸鲜，擅长海鲜和肉类（如霸王别姬、烤羊腿）。</li></ul></> ,
        ...
        zhe: {
            ...
            origin: <><p>浙菜起源于春秋时期的越国（今浙江地区），依托浙江“七山一水二分田”的地理环境，融合了山区、沿海、平原的食材特色，风格与苏菜相近，但更突出“鲜爽”。</p><ul className="list-disc pl-5 mt-2 space-y-1"><li>**杭帮菜**（杭州菜）：以西湖周边食材为主，口味清鲜，擅长做鱼和禽类（如西湖醋鱼、叫花鸡）。</li><li>**甬帮菜**（宁波菜）：以海鲜为主，口味咸鲜，擅长腌制和蒸制（如冰糖甲鱼、雪菜大汤黄鱼）。</li><li>**绍帮菜**（绍兴菜）：以黄酒为特色调料，口味醇厚，擅长炖、蒸（如梅干菜焖肉、醉鸡）。</li><li>**瓯菜**（温州菜）：以沿海小海鲜为主，口味鲜淡，擅长白灼和凉拌（如温州鱼丸、江蟹生）。</li></ul></>,
        ...
        min: {
            ...
            origin: <><p>闽菜起源于闽越地区（今福建地区），受福建“八山一水一分田”的地理影响，融合了山区食材（笋、菇、禽畜）和沿海海鲜（鱼、虾、贝类），同时受东南亚饮食文化影响，口味独特。</p><ul className="list-disc pl-5 mt-2 space-y-1"><li>**福州菜**：闽菜的核心，口味酸甜，擅长红糟调味和汤菜（如佛跳墙、荔枝肉）。</li><li>**闽南菜**（厦门、泉州菜）：口味鲜淡，擅长海鲜和小吃（如沙茶面、土笋冻）。</li><li>**闽西菜**（龙岩、三明菜）：受客家文化影响，口味咸香，擅长山珍和肉类（如白斩河田鸡、涮九品）。</li></ul></>,
        ...
        xiang: {
            ...
            origin: <><p>湘菜起源于春秋战国时期的楚国（今湖南地区），受湖南潮湿气候影响，饮食以“辣”驱寒祛湿，口味浓烈，风格豪放，与川菜并称“麻辣双雄”（川菜偏“麻辣”，湘菜偏“香辣”）。</p><ul className="list-disc pl-5 mt-2 space-y-1"><li>**湘江流域菜**（长沙、湘潭菜）：湘菜的核心，口味香辣，擅长炒、煨，菜品兼具家常与宴席特色（如剁椒鱼头、毛氏红烧肉）。</li><li>**洞庭湖区菜**（岳阳、常德菜）：以河鲜和水禽为主，口味鲜辣，擅长炖、蒸（如常德钵子菜、岳阳姜辣蛇）。</li><li>**湘西菜**（张家界、湘西州菜）：受少数民族（土家族、苗族）文化影响，口味酸辣，擅长腊味和山珍（如湘西腊肉、酸肉）。</li></ul></>,
        ...
        hui: {
            ...
            origin: <><p>徽菜起源于徽州地区（今安徽黄山、歙县、婺源一带，古属徽州），依托皖南山区的丰富山珍资源（笋、菇、石鸡、蕨菜），受徽商文化影响，菜品兼具“质朴”与“厚重”，是八大菜系中“山野风味”的代表。</p><ul className="list-disc pl-5 mt-2 space-y-1"><li>**皖南菜**（黄山、歙县菜）：徽菜的核心，以山珍为主，口味醇厚，擅长烧、炖、蒸（如臭鳜鱼、毛豆腐）。</li><li>**沿江菜**（芜湖、安庆菜）：以河鲜为主，口味鲜淡，擅长蒸、煮（如清蒸刀鱼、无为板鸭）。</li><li>**沿淮菜**（蚌埠、阜阳菜）：受鲁菜影响，口味咸鲜，擅长烧、炸（如符离集烧鸡、奶汁肥王鱼）。</li></ul></>,
...
const CuisineCard: React.FC<{ cuisine: Cuisine, t: any }> = ({ cuisine, t }) => {
    ...
    const renderFeatures = (featuresNode: React.ReactNode) => {
        ...
        return childrenArray.map((child, index) => {
            ...
            if (typeof childContent !== 'string') return child;

            const parts = childContent.split('：');
            if (parts.length < 2) return <p key={index}>{childContent}</p>;

...
const cuisineData: Record<string, Record<string, Cuisine>> = {
    'zh-CN': {
        lu: {
            ...
            origin: <>鲁菜是中国八大菜系中历史最悠久、技法最丰富的菜系，起源于春秋战国时期的齐国和鲁国（今山东地区），受儒家“食不厌精，脍不厌细”的饮食思想影响深远。<br />主要分为三大流派：<br />- **济南菜**：以清汤、奶汤菜见长，口味醇厚，注重火候。<br />- **胶东菜**（福山菜）：以海鲜为主，讲究鲜活，口味清淡鲜爽，擅长蒸、炸、扒。<br />- **孔府菜**：源于曲阜孔府，是“官府菜”的代表，讲究礼仪和排场，用料奢华，工艺复杂。</>,
            features: <><b>技法</b>：擅长爆、炒、烧、扒、熘，尤其重视“吊汤”（清汤、奶汤），汤清而鲜、浓而不腻，是鲁菜的灵魂（如“清汤燕菜”“奶汤蒲菜”）。<br /><b>口味</b>：咸鲜为主，略带酱香，口感醇厚，不尚辛辣，注重突出食材本味。<br /><b>食材</b>：依托山东半岛的海鲜资源（如海参、鲍鱼、对虾）和内陆的禽畜、蔬菜（如章丘大葱、莱芜生姜）。</>,
            classicDishes: [
        ...
        chuan: {
            ...
            origin: <>川菜起源于古代巴国和蜀国（今四川、重庆地区），受巴蜀文化影响，结合了当地潮湿气候对“驱寒祛湿”的饮食需求，在明清时期形成规模，现分为**川味菜肴**和**川味小吃**两大体系，核心流派为：<br />- **上河帮**（成都、乐山菜）：口味温和，注重调味的层次感，擅长做鱼和小吃（如乐山钵钵鸡、成都夫妻肺片）。<br />- **下河帮**（重庆、万州菜）：口味浓烈，以麻辣鲜香为主，擅长江湖菜（如重庆火锅、万州烤鱼）。<br />- **小河帮**（自贡、内江菜）：以“鲜辣”“味厚”为特色，擅长做兔肉和河鲜（如冷吃兔、鲜锅兔）。</>,
            features: <><b>技法</b>：擅长炒、爆、煸、烧、腌，尤其重视“调味”，被誉为“调味之王”，常用辣椒、花椒、姜、蒜、豆瓣酱、泡椒、醪糟等调料。<br /><b>口味</b>：“百菜百味”是核心，以麻辣、鱼香、宫保、酸辣、椒麻、怪味等口味著称，同一食材可通过不同调味呈现完全不同的风味。<br /><b>食材</b>：善用四川本地食材，如辣椒（二荆条、小米辣）、花椒（汉源花椒）、豆瓣、泡菜、兔肉、鳝鱼、竹笋等。</>,
            classicDishes: [
        ...
        yue: {
            ...
            origin: <>粤菜起源于岭南地区（今广东、广西东部、海南），受中原文化、海外贸易（如东南亚、欧美）影响，形成了“兼容并蓄、注重鲜活”的特点，是中国八大菜系中**海外影响力最大**的菜系。<br />主要流派：<br />- **广府菜**（广州、佛山菜）：以清淡、鲜爽为主，擅长清蒸、白灼，注重食材本味（如清蒸石斑鱼、白灼虾）。<br />- **潮汕菜**（潮州、汕头菜）：以海鲜和卤味见长，刀工精细，口味鲜香，擅长腌制和砂锅菜（如潮汕牛肉火锅、卤鹅）。<br />- **客家菜**（梅州、惠州菜）：源于中原移民，口味偏咸香，擅长炖、煲、酿，注重食材的“质朴本味”（如客家酿豆腐、梅菜扣肉）。</>,
            features: <><b>技法</b>：擅长清蒸、白灼、烤、煲、炖，追求“鲜活”，烹饪时间短，最大程度保留食材的原味和营养（如“清蒸”要求火候精准，鱼眼突出即熟）。<br /><b>口味</b>：清、鲜、嫩、滑、爽，极少使用辛辣调料，注重“淡而不寡”，调味以盐、糖、生抽、蚝油为主，部分菜品带微甜（如叉烧肉）。<br /><b>食材</b>：“凡能食者皆可为菜”，食材极为丰富，涵盖海鲜（鱼、虾、蟹、贝类）、禽畜、野味、蔬果，尤其擅长处理“鲜活”食材（如龙虎斗、白切鸡）。</>,
            classicDishes: [
        ...
        su: {
            ...
            origin: <>苏菜起源于春秋战国时期的吴国（今江苏地区），受江南水乡文化和文人雅士的审美影响，以“精细、雅致”著称，与浙菜并称“江南菜系”的核心。<br />主要流派：<br />- **淮扬菜**（淮安、扬州菜）：苏菜的核心，口味清鲜平和，擅长河鲜和禽畜，注重刀工和造型（如扬州炒饭、清炖狮子头）。<br />- **金陵菜**（南京菜）：口味醇和，擅长炖、焖、烤，因南京曾为都城，菜品兼具“家常”与“宫廷”特色（如盐水鸭、鸭血粉丝汤）。<br />- **苏锡菜**（苏州、无锡菜）：口味偏甜，擅长做水产和甜食（如松鼠鳜鱼、无锡酱排骨）。<br />- **徐海菜**（徐州、连云港菜）：受鲁菜影响，口味偏咸鲜，擅长海鲜和肉类（如霸王别姬、烤羊腿）。</>,
            features: <><b>技法</b>：擅长炖、焖、蒸、炒、煨，刀工极为精细（如“文思豆腐”能将豆腐切成长细如丝的形状），造型讲究“色香味形”俱全，宛如艺术品。<br /><b>口味</b>：清鲜平和，咸甜适中，部分流派（如苏锡菜）带明显甜味，注重突出食材的本味，不尚浓烈调料。<br /><b>食材</b>：依托江南水乡的河鲜资源（如鳜鱼、鲈鱼、鳝鱼、螃蟹）和田园蔬果（如茭白、莲藕、莼菜），食材以“鲜活、细嫩”为上。</>,
            classicDishes: [
        ...
        zhe: {
            ...
            origin: <>浙菜起源于春秋时期的越国（今浙江地区），依托浙江“七山一水二分田”的地理环境，融合了山区、沿海、平原的食材特色，风格与苏菜相近，但更突出“鲜爽”。<br />主要流派：<br />- **杭帮菜**（杭州菜）：以西湖周边食材为主，口味清鲜，擅长做鱼和禽类（如西湖醋鱼、叫花鸡）。<br />- **甬帮菜**（宁波菜）：以海鲜为主，口味咸鲜，擅长腌制和蒸制（如冰糖甲鱼、雪菜大汤黄鱼）。<br />- **绍帮菜**（绍兴菜）：以黄酒为特色调料，口味醇厚，擅长炖、蒸（如梅干菜焖肉、醉鸡）。<br />- **瓯菜**（温州菜）：以沿海小海鲜为主，口味鲜淡，擅长白灼和凉拌（如温州鱼丸、江蟹生）。</>,
            features: <><b>技法</b>：擅长蒸、炒、烩、炖、煨，注重“鲜活”和“本味”，刀工精细，造型清丽，与江南的自然风光相得益彰。<br /><b>口味</b>：清鲜、爽脆、嫩滑，部分菜品（如甬帮菜）带微咸，绍帮菜因用黄酒调味，带有独特的酒香。<br /><b>食材</b>：以西湖水产（草鱼、鳜鱼、虾）、沿海海鲜（黄鱼、带鱼、梭子蟹）、山区笋菇（天目笋干、香菇）为核心，讲究“不时不食”（如春季吃笋、秋季吃蟹）。</>,
            classicDishes: [
        ...
        min: {
            ...
            origin: <>闽菜起源于闽越地区（今福建地区），受福建“八山一水一分田”的地理影响，融合了山区食材（笋、菇、禽畜）和沿海海鲜（鱼、虾、贝类），同时受东南亚饮食文化影响，口味独特。<br />主要流派：<br />- **福州菜**：闽菜的核心，口味酸甜，擅长红糟调味和汤菜（如佛跳墙、荔枝肉）。<br />- **闽南菜**（厦门、泉州菜）：口味鲜淡，擅长海鲜和小吃（如沙茶面、土笋冻）。<br />- **闽西菜**（龙岩、三明菜）：受客家文化影响，口味咸香，擅长山珍和肉类（如白斩河田鸡、涮九品）。</>,
            features: <><b>技法</b>：擅长炖、煨、蒸、炒，尤其重视“汤”的熬制（如“佛跳墙”需慢炖数小时），同时善用“红糟”（糯米发酵制成，兼具去腥和增色作用）调味。<br /><b>口味</b>：酸甜、鲜香、清淡，福州菜偏酸甜（如荔枝肉、醉排骨），闽南菜偏鲜淡，闽西菜偏咸香，部分菜品带微辣（受客家饮食影响）。<br /><b>食材</b>：以海鲜（大黄鱼、鲍鱼、扇贝）、山区笋菇（建瓯笋干、武夷山香菇）、禽畜（河田鸡、番鸭）为主，红糟、虾油、沙茶酱是特色调料。</>,
            classicDishes: [
        ...
        xiang: {
            ...
            origin: <>湘菜起源于春秋战国时期的楚国（今湖南地区），受湖南潮湿气候影响，饮食以“辣”驱寒祛湿，口味浓烈，风格豪放，与川菜并称“麻辣双雄”（川菜偏“麻辣”，湘菜偏“香辣”）。<br />主要流派：<br />- **湘江流域菜**（长沙、湘潭菜）：湘菜的核心，口味香辣，擅长炒、煨，菜品兼具家常与宴席特色（如剁椒鱼头、毛氏红烧肉）。<br />- **洞庭湖区菜**（岳阳、常德菜）：以河鲜和水禽为主，口味鲜辣，擅长炖、蒸（如常德钵子菜、岳阳姜辣蛇）。<br />- **湘西菜**（张家界、湘西州菜）：受少数民族（土家族、苗族）文化影响，口味酸辣，擅长腊味和山珍（如湘西腊肉、酸肉）。</>,
            features: <><b>技法</b>：擅长炒、爆、煨、炖、蒸，尤其重视“辣”的运用，常用辣椒（剁椒、泡椒、干辣椒）、花椒、姜、蒜、豆豉、紫苏等调料，炒法讲究“急火快炒”，保持食材的爽脆。<br /><b>口味</b>：香辣、酸辣、鲜辣，辣中带鲜，醇厚不燥，不同于川菜的“麻辣”（突出花椒的麻），湘菜更突出辣椒的“香”与“鲜”（如剁椒的发酵香）。<br /><b>食材</b>：依托湘江、洞庭湖的河鲜（鲫鱼、甲鱼、小龙虾）和山区的禽畜、腊味（湘西腊肉、东安鸡），辣椒、紫苏、藠头是特色食材。</>,
            classicDishes: [
        ...
        hui: {
            ...
            origin: <>徽菜起源于徽州地区（今安徽黄山、歙县、婺源一带，古属徽州），依托皖南山区的丰富山珍资源（笋、菇、石鸡、蕨菜），受徽商文化影响，菜品兼具“质朴”与“厚重”，是八大菜系中“山野风味”的代表。<br />主要流派：<br />- **皖南菜**（黄山、歙县菜）：徽菜的核心，以山珍为主，口味醇厚，擅长烧、炖、蒸（如臭鳜鱼、毛豆腐）。<br />- **沿江菜**（芜湖、安庆菜）：以河鲜为主，口味鲜淡，擅长蒸、煮（如清蒸刀鱼、无为板鸭）。<br />- **沿淮菜**（蚌埠、阜阳菜）：受鲁菜影响，口味咸鲜，擅长烧、炸（如符离集烧鸡、奶汁肥王鱼）。</>,
            features: <><b>技法</b>：擅长烧、炖、蒸、熏，注重“火功”，炖菜讲究“小火慢炖”，使食材软烂入味；同时善用“腌制”“发酵”（如臭鳜鱼、毛豆腐的发酵工艺），形成独特风味。<br /><b>口味</b>：醇厚、咸香、微辣，因山区食材偏“粗”（如笋干、腊肉），调味以盐、酱油、辣椒为主，突出食材的“山野鲜香”，不尚清淡。<br /><b>食材</b>：以皖南山区的山珍（笋干、香菇、石鸡、竹鼠）、腌腊制品（徽州腊肉、香肠）、河鲜（刀鱼、银鱼）为主，“臭鳜鱼”“毛豆腐”是徽菜最具代表性的“发酵食材”。</>,
            classicDishes: [
...
const CuisineCard: React.FC<{ cuisine: Cuisine, t: any }> = ({ cuisine, t }) => {
    ...
    const renderFeatures = (featuresNode: React.ReactNode) => {
        if (typeof (featuresNode as React.ReactElement)?.props?.children !== 'string') {
            return featuresNode; // Fallback for unexpected format
        }
        
        const featuresText = (featuresNode as React.ReactElement).props.children;
        const featureLines = featuresText.split('<br />');

        return featureLines.map((line: string, index: number) => {
            const parts = line.split('：');
            if (parts.length < 2) return <p key={index}>{line}</p>;

            const labelMatch = parts[0].match(/<b>(.*?)<\/b>/);
            const label = labelMatch ? labelMatch[1] : parts[0];
            const content = parts.slice(1).join('：');
            const Icon = featureIcons[label] || Star;

            return (
                <div key={index} className="flex items-start">
                    <Icon className="h-4 w-4 mt-0.5 mr-2 text-primary/70 shrink-0"/>
                    <div><b>{label}</b>：{content}</div>
                </div>
            );
        });
    };
...
export default function EightCuisinesPage() {
  ...
  const cuisines = useMemo(() => {
    ...
    // Fallback to English if the current language data is incomplete
    return Object.values(cuisineData['en']);
  }, [currentLanguage]);
  
  // A simple check to see if we have valid cuisine data to render
  if (cuisines.length === 0 || !cuisineData['en']) {
